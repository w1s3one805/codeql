  ...
  Impl::Private::External::SourceSinkInterpretationInputSig<Location>
{
  ...
  predicate sourceElement(Element e, string output, string kind, string model) {
    exists(
      string namespace, string type, boolean subtypes, string name, string signature, string ext,
      SourceOrSinkElement baseSource, string originalOutput, int madId
    |
      sourceModel(namespace, type, subtypes, name, signature, ext, originalOutput, kind, _, madId) and
      model = "MaD:" + madId and
  ...
  predicate sinkElement(Element e, string input, string kind, string model) {
    exists(
      string namespace, string type, boolean subtypes, string name, string signature, string ext,
      SourceOrSinkElement baseSink, string originalInput, int madId
    |
      sinkModel(namespace, type, subtypes, name, signature, ext, originalInput, kind, _, madId) and
      model = "MaD:" + madId and
...
module Private {
  ...
  module External {
    ...
    predicate summaryElement(
      ...
      exists(
        string namespace, string type, boolean subtypes, string name, string signature, string ext,
        string originalInput, string originalOutput, Callable baseCallable, int madId
      |
