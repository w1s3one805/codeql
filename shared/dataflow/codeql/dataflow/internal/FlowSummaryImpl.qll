  ...
  module Private {
    ...
    module External {
      ...
      signature module SourceSinkInterpretationInputSig<LocationSig Location> {
         ...
         */
        predicate sourceElement(Element n, string output, string kind, string model);

        /**
         * Holds if an external sink specification exists for `n` with input specification
         * `input` and kind `kind`.
         */
        predicate sinkElement(Element n, string input, string kind, string model);
        ...
        SourceSinkInterpretationInputSig<Location> SourceSinkInterpretationInput>
      {
        ...
        private predicate sourceElementRef(
          ...
          exists(SourceOrSinkElement e |
            sourceElement(e, output, kind, model) and
        ...
        private predicate sinkElementRef(
          ...
          exists(SourceOrSinkElement e |
            sinkElement(e, input, kind, model) and
